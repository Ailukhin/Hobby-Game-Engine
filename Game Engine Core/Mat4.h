...
namespace EngineCore
{
	...
	protected:
		...
		void privSetGeneralHint() { this->_u_m15 &= (unsigned int)(0xFFFFFFF8); };
		void privSetScaleHint() { this->_u_m15 |= (unsigned int)(Mat4::Hint::Scale); };
		void privSetRotHint() { this->_u_m15 |= (unsigned int)(Mat4::Hint::Rot); };
		void privSetTransHint() { this->_u_m15 |= (unsigned int)(Mat4::Hint::Trans); };
		void privSetNewHint(Hint A, Hint B) { this->_u_m15 |= (unsigned int)(A); this->_u_m15 |= (unsigned int)(B); };
